...
_MANIFEST: list[dict] = [
    ...
    {"name": "device-diagnostics.schema.json",
     ...
     "media_type": "application/json",
     "description": "Device diagnostics payload; core vocabulary + vendorSpecific"},
    {"name": "diagnostics-vocabulary.json",
     "path": "spec/private-profile/diagnostics-vocabulary.json",
     "media_type": "application/json",
     "description": "Normative core diagnostics vocabulary: field names, units, standards, tier defaults + the vendorSpecific routing rule"},
    {"name": "accuracy-class-vocabulary.json",
     "path": "spec/private-profile/accuracy-class-vocabulary.json",
     "media_type": "application/json",
     "description": "Normative accuracy-class taxonomy: the bands an adapter declares, their boundaries, and how a band resolves to a nominal accuracy"},
